...
import 'package:kakotel_test/core/extensions/context_extensions.dart';
...
class AppInput extends StatefulWidget {
  ...
  /// Constructeur nommé pour un champ de recherche
  AppInput.search({
    super.key,
    this.height,
    this.initialValue,
    ...
    this.contentPadding,
         ...
         filled: true,
         isDense: true,
         fillColor: AppColors.quaternaire,
         hint: Text(
           "Rechercher un document, un article...",
           style: context.textTheme.bodySmall!.copyWith(
             fontSize: 11.sp,
             color: AppColors.textGrey,
           ),
         ),
         contentPadding: EdgeInsets.symmetric(horizontal: 40.w, vertical: 0.h),
